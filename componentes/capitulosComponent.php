...
include $_SERVER['DOCUMENT_ROOT'] . '/sgigesconnew/src/Capitulos/Interfaces/Views/capitulosDataTable.php';
?>
...
const API_CAPITULOS = '/sgigesconnew/src/Capitulos/Interfaces/CapituloController.php';

console.log('Capítulos - Proyecto filtrado:', ID_PROYECTO_FILTRO);
</script>

<script src="/sgigesconnew/src/Capitulos/Interfaces/Views/capitulosDataTable.js"></script>
