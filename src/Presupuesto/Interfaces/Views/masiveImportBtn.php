    ...
    <div class="card-body">
      ...
      <form id="formImportar" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <select id="id_presupuesto" name="id_presupuesto" class="form-select" disabled>
                <option value="">Primero seleccione un proyecto</option>
            </select>
            <small class="text-muted">Selecciona un presupuesto existente o crea uno nuevo</small>
        </div>
...
<script>
    ...
    if (!isProjectMode || !selectedProjectId) {
        const cardBody = document.querySelector('#cardImportacionMasiva .card-body');
        if (cardBody) {
            cardBody.innerHTML = `
